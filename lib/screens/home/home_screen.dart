        ...
        actions: [
          ...
          Container(
            ...
            child: IconButton(
              ...
              tooltip: AppLocalizations.of(context)!.cloudinaryTest,
              onPressed: () {
                final role = authProvider.user?.role ?? 'user';
                if (authProvider.isLoggedIn && role == 'admin') {
                  Navigator.pushNamed(context, AppRouter.cloudinaryTest);
                  return;
                }
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(AppLocalizations.of(context)!.adminOnly), backgroundColor: Colors.red),
                );
              },
            ),
          ),
