...
class _AdminPaymentsScreenState extends State<AdminPaymentsScreen> {
  ...
  String _searchQuery = '';
  final Map<String, Future<app_user.User?>> _userFutures = {};

  Future<app_user.User?> _getUser(String userId) {
    return _userFutures.putIfAbsent(userId, () => FirebaseService.getUser(userId));
  }
                                      ...
                                      if (userId.isEmpty)
                                        ...
                                        FutureBuilder<app_user.User?>(
                                          ...
                                          builder: (context, snap) {
                                            final u = snap.data;
                                            if (u == null) return Text('Tài khoản: $userId');
                                            return Text('Tài khoản: ${u.name} (${u.email})');
                                          },
                                        ),
                                  ...
                                  child: userId.isEmpty
                                      ...
                                      : FutureBuilder<app_user.User?>(
                                          ...
                                          builder: (context, snap) {
                                            final u = snap.data;
                                            if (u == null) {
                                              return Text(userId, style: const TextStyle(fontWeight: FontWeight.w600));
                                            }
                                            return Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
